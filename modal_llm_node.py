...
if __package__:
    ...
    from .modal_llm_runtime import run_modal_llm_inference
...
class ModalLLM(io.ComfyNode):
    ...
    def execute(
        ...
        def report_progress(generated_tokens: int) -> None:
            """Mirror token generation into ComfyUI progress and cancellation."""
            comfy.model_management.throw_exception_if_processing_interrupted()
            progress_bar.update_absolute(generated_tokens, max_new_tokens)
        ...
        progress_bar.update_absolute(result.metadata["output_tokens"], max_new_tokens)
