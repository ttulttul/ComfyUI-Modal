...
- Warm containers now pre-initialize ComfyUI core during `@modal.enter`, so built-in node registry setup and execution-module imports can be captured in the memory snapshot instead of being paid again on every request
