...
- remote mode now assumes you have deployed [comfyui_modal_sync_cloud.py](/home/user/git/ComfyUI-Modal/comfyui_modal_sync_cloud.py) once, for example with `modal deploy comfyui_modal_sync_cloud.py`
