...
def test_workflow_r2_configuration_resolves_controller_signing_client(
    ...
    execution_assignment_runtime_module: Any,
    ...
    monkeypatch.setattr(execution_assignment_runtime_module, "R2CredentialStore", Store)
...
def test_safe_configuration_payload_adds_cached_r2_bucket_usage(
    api_intercept_module: Any,
    execution_scheduling_module: Any,
    execution_plan_reporting_module: Any,
    remote_configurations_module: Any,
    r2_cache_module: Any,
    monkeypatch: Any,
) -> None:
    ...
    execution_plan_reporting_module._R2_STORAGE_USAGE_CACHE.clear()
    monkeypatch.setattr(execution_plan_reporting_module, "R2CredentialStore", Store)
    monkeypatch.setattr(execution_plan_reporting_module, "R2CacheClient", Client)
